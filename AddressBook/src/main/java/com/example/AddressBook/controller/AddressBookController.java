...
public class AddressBookController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addAddress(@Valid @RequestBody AddressBookDTO dto) {
    ...
    public ResponseEntity<?> updateAddress(@PathVariable Long id, @Valid @RequestBody AddressBookDTO dto) {
